...
for (i in savedPayment) {
	...
	$('#profiles-list').append($('<li class="list-group-item" data-id="' + savedPayment[i].id + '">').html('<p>' + savedPayment[i].type + ': ****************' + last4 + '</p><div class="controls"><i class="material-icons delete">close</i></div>'));
}
