...
for (i in savedShipping) {
	$('#profiles-list').append($('<li class="list-group-item" data-id="' + savedShipping[i].id + '">').html('<p>' + savedShipping[i].name + ', ' + savedShipping[i].address + ', ' + savedShipping[i].zip + '</p><div class="controls"><i class="material-icons delete">close</i></div>'));
}
